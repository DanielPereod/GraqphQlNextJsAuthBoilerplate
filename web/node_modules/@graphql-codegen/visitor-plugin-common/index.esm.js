...
function hasConditionalDirectives(directives) {
...
class OperationVariablesToObject {
    ...
    wrapAstTypeWithModifiers(_baseType, _typeNode) {
...
export type IDirectiveResolvers${contextType} = ${name}<ContextType>;`
    ...
    ObjectTypeDefinition(node) {
        ...
        if (!isRootType) {
            fieldsContent.push(indent(`__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>${this.getPunctuation(declarationKind)}`));
        }
